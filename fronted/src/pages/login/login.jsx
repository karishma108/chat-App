...
const Login = () => {
    ...
    bg-opacity-0">
                <h1 className='text-3xl font-semibold text-center text-gray-300'>
                    Login
                    <span className="text-white-500">MessagesMesh</span>
                </h1>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div>
                     ...
                     <Link to='/signup' className="text-sm hover:underline hover:text-blue-600 mt-2 inline-block" style={{ color: 'orange' }}>
