  ...
  return (
    ...
    bg-opacity-0" >
      <h1 className="text-3xl font-semibold text-center text-gray-300">
        Sign Up <span className="text-blue-500">MessagesMesh</span>
      </h1>
    ...
    placeholder="confirm password"
     ...
     <Link to={"/login" }
      className="text-sm hover:underline hover:text-white-600 mt-2 inline-block"style={{ color: 'orange' }}
       >
